...
# CHECK-NEXT:          %extracted_slice_3 = tensor.extract_slice %extracted_slice_1[%c0, 0] [1, 1] [1, 1] : tensor<2x1xf32> to tensor<1x1xf32>
# CHECK-NEXT:          %5 = vector.transfer_read %extracted_slice_3[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x1xf32>, vector<1x1xf32>
# CHECK-NEXT:          %extracted_slice_4 = tensor.extract_slice %extracted_slice_1[%c1, 0] [1, 1] [1, 1] : tensor<2x1xf32> to tensor<1x1xf32>
# CHECK-NEXT:          %6 = vector.transfer_read %extracted_slice_4[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x1xf32>, vector<1x1xf32>
# CHECK-NEXT:          %7 = scf.for %arg7 = %c0 to %c32 step %c16 iter_args(%arg8 = %extracted_slice_2) -> (tensor<2x32xf32>) {
# CHECK-NEXT:            %extracted_slice_5 = tensor.extract_slice %extracted_slice_0[0, %arg7] [1, 16] [1, 1] : tensor<1x32xf32> to tensor<1x16xf32>
# CHECK-NEXT:            %extracted_slice_6 = tensor.extract_slice %arg8[0, %arg7] [2, 16] [1, 1] : tensor<2x32xf32> to tensor<2x16xf32>
# CHECK-NEXT:            %extracted_slice_7 = tensor.extract_slice %extracted_slice_6[%c0, 0] [1, 16] [1, 1] : tensor<2x16xf32> to tensor<1x16xf32>
# CHECK-NEXT:            %8 = vector.transfer_read %extracted_slice_5[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:            %9 = vector.transfer_read %extracted_slice_7[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:            %10 = vector.contract {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %5, %8, %9 : vector<1x1xf32>, vector<1x16xf32> into vector<1x16xf32>
# CHECK-NEXT:            %11 = vector.transfer_write %10, %extracted_slice_7[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, tensor<1x16xf32>
# CHECK-NEXT:            %inserted_slice_8 = tensor.insert_slice %11 into %extracted_slice_6[%c0, 0] [1, 16] [1, 1] : tensor<1x16xf32> into tensor<2x16xf32>
# CHECK-NEXT:            %extracted_slice_9 = tensor.extract_slice %inserted_slice_8[%c1, 0] [1, 16] [1, 1] : tensor<2x16xf32> to tensor<1x16xf32>
# CHECK-NEXT:            %12 = vector.transfer_read %extracted_slice_9[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:            %13 = vector.contract {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %6, %8, %12 : vector<1x1xf32>, vector<1x16xf32> into vector<1x16xf32>
# CHECK-NEXT:            %14 = vector.transfer_write %13, %extracted_slice_9[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, tensor<1x16xf32>
# CHECK-NEXT:            %inserted_slice_10 = tensor.insert_slice %14 into %inserted_slice_8[%c1, 0] [1, 16] [1, 1] : tensor<1x16xf32> into tensor<2x16xf32>
...
# CHECK-NEXT:          %4 = vector.transfer_read %subview_4[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
...
# CHECK-NEXT:          %5 = vector.transfer_read %subview_5[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
# CHECK-NEXT:          %6 = scf.for %arg7 = %c0 to %c32 step %c16 iter_args(%arg8 = %subview_3) -> (memref<2x32xf32, strided<[32, 1], offset: ?>>) {
...
# CHECK-NEXT:            %10 = vector.extract %4[0, 0] : f32 from vector<1x1xf32>
...
# CHECK-NEXT:            %16 = vector.extract %7[0] : vector<16xf32> from vector<1x16xf32>
# CHECK-NEXT:            %17 = vector.extract %5[0, 0] : f32 from vector<1x1xf32>
...
# CHECK-NEXT:          memref.copy %6, %subview_6 : memref<2x32xf32, strided<[32, 1], offset: ?>> to memref<2x32xf32, strided<[32, 1], offset: ?>>
