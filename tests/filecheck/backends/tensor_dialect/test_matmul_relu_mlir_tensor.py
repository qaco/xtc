...
# CHECK-NEXT:      %7 = transform.structured.match attributes {"./k"} in %6 : (!transform.any_op) -> !transform.any_op
# CHECK-NEXT:      %8 = transform.get_parent_op %7 {isolated_from_above} : (!transform.any_op) -> !transform.any_op
...
# CHECK-NEXT:      } : !transform.any_op
# CHECK-NEXT:      %9 = transform.structured.match attributes {__xtc_id_relu_} in %arg0 : (!transform.any_op) -> !transform.any_op
# CHECK-NEXT:      %tiled_linalg_op_10, %loops_11 = transform.structured.tile_using_for %9 tile_sizes [1] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
...
# CHECK-NEXT:        %5 = scf.for %arg5 = %c0 to %c32 step %c1 iter_args(%arg6 = %extracted_slice) -> (tensor<1x32xf32>) {
# CHECK-NEXT:          %extracted_slice_3 = tensor.extract_slice %arg6[0, %arg5] [1, 1] [1, 1] : tensor<1x32xf32> to tensor<1x1xf32>
# CHECK-NEXT:          %6 = linalg.fill {__xtc_id_matmul_0_} ins(%cst : f32) outs(%extracted_slice_3 : tensor<1x1xf32>) -> tensor<1x1xf32>
# CHECK-NEXT:          %inserted_slice_4 = tensor.insert_slice %6 into %arg6[0, %arg5] [1, 1] [1, 1] : tensor<1x1xf32> into tensor<1x32xf32>
...
# CHECK-NEXT:        %5 = scf.for %arg5 = %c0 to %c4 step %c2 iter_args(%arg6 = %arg4) -> (tensor<4x32xf32>) {
...
# CHECK-NEXT:          %extracted_slice_6 = tensor.extract_slice %extracted_slice_4[%c0, 0] [1, 1] [1, 1] : tensor<2x1xf32> to tensor<1x1xf32>
# CHECK-NEXT:          %6 = vector.transfer_read %extracted_slice_6[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x1xf32>, vector<1x1xf32>
# CHECK-NEXT:          %extracted_slice_7 = tensor.extract_slice %extracted_slice_4[%c1, 0] [1, 1] [1, 1] : tensor<2x1xf32> to tensor<1x1xf32>
# CHECK-NEXT:          %7 = vector.transfer_read %extracted_slice_7[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x1xf32>, vector<1x1xf32>
# CHECK-NEXT:          %8 = scf.for %arg7 = %c0 to %c32 step %c16 iter_args(%arg8 = %extracted_slice_5) -> (tensor<2x32xf32>) {
# CHECK-NEXT:            %extracted_slice_8 = tensor.extract_slice %extracted_slice_3[0, %arg7] [1, 16] [1, 1] : tensor<1x32xf32> to tensor<1x16xf32>
# CHECK-NEXT:            %extracted_slice_9 = tensor.extract_slice %arg8[0, %arg7] [2, 16] [1, 1] : tensor<2x32xf32> to tensor<2x16xf32>
# CHECK-NEXT:            %extracted_slice_10 = tensor.extract_slice %extracted_slice_9[%c0, 0] [1, 16] [1, 1] : tensor<2x16xf32> to tensor<1x16xf32>
# CHECK-NEXT:            %9 = vector.transfer_read %extracted_slice_8[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:            %10 = vector.transfer_read %extracted_slice_10[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:            %11 = vector.contract {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %6, %9, %10 : vector<1x1xf32>, vector<1x16xf32> into vector<1x16xf32>
# CHECK-NEXT:            %12 = vector.transfer_write %11, %extracted_slice_10[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, tensor<1x16xf32>
# CHECK-NEXT:            %inserted_slice_11 = tensor.insert_slice %12 into %extracted_slice_9[%c0, 0] [1, 16] [1, 1] : tensor<1x16xf32> into tensor<2x16xf32>
# CHECK-NEXT:            %extracted_slice_12 = tensor.extract_slice %inserted_slice_11[%c1, 0] [1, 16] [1, 1] : tensor<2x16xf32> to tensor<1x16xf32>
# CHECK-NEXT:            %13 = vector.transfer_read %extracted_slice_12[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:            %14 = vector.contract {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %7, %9, %13 : vector<1x1xf32>, vector<1x16xf32> into vector<1x16xf32>
# CHECK-NEXT:            %15 = vector.transfer_write %14, %extracted_slice_12[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, tensor<1x16xf32>
# CHECK-NEXT:            %inserted_slice_13 = tensor.insert_slice %15 into %inserted_slice_11[%c1, 0] [1, 16] [1, 1] : tensor<1x16xf32> into tensor<2x16xf32>
...
# CHECK-NEXT:          } {"./j"}
# CHECK-NEXT:          %inserted_slice = tensor.insert_slice %8 into %arg6[%arg5, 0] [2, 32] [1, 1] : tensor<2x32xf32> into tensor<4x32xf32>
# CHECK-NEXT:          scf.yield %inserted_slice : tensor<4x32xf32>
# CHECK-NEXT:        } {"./i"}
# CHECK-NEXT:        scf.yield %5 : tensor<4x32xf32>
# CHECK-NEXT:      } {"./k"}
# CHECK-NEXT:      %c0_0 = arith.constant 0 : index
# CHECK-NEXT:      %c4_1 = arith.constant 4 : index
# CHECK-NEXT:      %c1_2 = arith.constant 1 : index
# CHECK-NEXT:      %4 = scf.for %arg3 = %c0_0 to %c4_1 step %c1_2 iter_args(%arg4 = %1) -> (tensor<4x32xf32>) {
...
# CHECK-NEXT:        %5 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel"]} ins(%extracted_slice, %cst : tensor<1x32xf32>, f32) outs(%extracted_slice_3 : tensor<1x32xf32>) attrs =  {__xtc_id_relu_} {
# CHECK-NEXT:        ^bb0(%in: f32, %in_4: f32, %out: f32):
# CHECK-NEXT:          %6 = arith.maximumf %in, %in_4 : f32
...
# CHECK-NEXT:          %subview_4 = memref.subview %subview_2[0, 0] [1, 1] [1, 1] : memref<2x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
# CHECK-NEXT:          %5 = vector.transfer_read %subview_4[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
# CHECK-NEXT:          %subview_5 = memref.subview %subview_2[1, 0] [1, 1] [1, 1] : memref<2x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
# CHECK-NEXT:          %6 = vector.transfer_read %subview_5[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
# CHECK-NEXT:          %7 = scf.for %arg7 = %c0 to %c32 step %c16 iter_args(%arg8 = %subview_3) -> (memref<2x32xf32, strided<[32, 1], offset: ?>>) {
# CHECK-NEXT:            %subview_7 = memref.subview %subview_1[0, %arg7] [1, 16] [1, 1] : memref<1x32xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            %subview_8 = memref.subview %arg8[0, %arg7] [2, 16] [1, 1] : memref<2x32xf32, strided<[32, 1], offset: ?>> to memref<2x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            %subview_9 = memref.subview %subview_8[0, 0] [1, 16] [1, 1] : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:            %9 = vector.transfer_read %subview_9[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x16xf32, strided<[32, 1], offset: ?>>, vector<1x16xf32>
# CHECK-NEXT:            %10 = vector.extract %8[0] : vector<16xf32> from vector<1x16xf32>
# CHECK-NEXT:            %11 = vector.extract %5[0, 0] : f32 from vector<1x1xf32>
# CHECK-NEXT:            %12 = vector.broadcast %11 : f32 to vector<16xf32>
# CHECK-NEXT:            %13 = vector.extract %9[0] : vector<16xf32> from vector<1x16xf32>
# CHECK-NEXT:            %14 = vector.fma %12, %10, %13 : vector<16xf32>
# CHECK-NEXT:            %15 = vector.insert %14, %cst [0] : vector<16xf32> into vector<1x16xf32>
# CHECK-NEXT:            vector.transfer_write %15, %subview_9[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, memref<1x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            %subview_10 = memref.subview %subview_8[0, 0] [1, 16] [1, 1] : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            memref.copy %subview_9, %subview_10 : memref<1x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            %subview_11 = memref.subview %subview_8[1, 0] [1, 16] [1, 1] : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:            %17 = vector.extract %8[0] : vector<16xf32> from vector<1x16xf32>
# CHECK-NEXT:            %18 = vector.extract %6[0, 0] : f32 from vector<1x1xf32>
...
# CHECK-NEXT:            %subview_12 = memref.subview %subview_8[1, 0] [1, 16] [1, 1] : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:            memref.copy %subview_8, %subview_13 : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<2x16xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:          memref.copy %7, %subview_6 : memref<2x32xf32, strided<[32, 1], offset: ?>> to memref<2x32xf32, strided<[32, 1], offset: ?>>
